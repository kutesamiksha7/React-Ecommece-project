...
const Navbar = () => {
    ...
    const{products, search, setSearch, getCartCount} = useContext(ShopContext);
...
//   const totalPages = Math.ceil(filteredProducts.length / productsPerPage);
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <ul className='hidden sm:flex gap-14 text-md text-grey-700'>
        ...
        <div className='flex items-center gap-6'>
            <div className='border w-full flex justify-center items-center relative'>
                ...
                <img onClick={handleSearch} src={assets.search_icon} className="w-5 cursor-pointer absolute right-[10px] bottom-0 top-0 self-center" alt="Search" />
            </div>
