...
const [productData, setProductData] = useState(false); //ceate state for one product
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <div className='flex item-center gap-1 mt-2'>
            <img src={assets.star_icon} alt="" className='w-3 self-center 5' />
            <img src={assets.star_icon} alt="" className='w-3 self-center 5' />
            <img src={assets.star_icon} alt="" className='w-3 self-center 5' />
            <img src={assets.star_icon} alt="" className='w-3 self-center 5' />
            <img src={assets.star_dull_icon} alt="" className='w-3 self-center 5' />
